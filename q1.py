...
def ols_no_intercept(X, y):
    ...
    Returns:
        w : (d,) slope vector
    """
    # closed-form solution without bias term
...
def load_data():
    ...
    X_train_outlier, y_train_outlier (q1_train.csv appended by q1_outliers.csv)
    """
    ...
    # append outliers to training set for the outlier experiment
